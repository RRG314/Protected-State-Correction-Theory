...
with CSV_PATH.open('w', newline='') as fh:
    ...
    writer.writerow(['claim_id','short_name','statement','status','evidence_type','confidence','key_files','next_action'])
    writer.writerows(claims)

rows_md = ['# Claim Registry', '', '| Claim ID | Short Name | Status | Evidence | Confidence | Key Files | Next Action |', '| --- | --- | --- | --- | --- | --- | --- |']
status_md = ['# Proof Status Map', '', '| Claim ID | Short Name | Exact Statement | Status | Evidence Type | Confidence | Key Files | Next Action |', '| --- | --- | --- | --- | --- | --- | --- | --- |']
for cid, short, statement, status, evidence, confidence, files, next_action in claims:
    rows_md.append(f'| {cid} | {short} | {status} | {evidence} | {confidence} | `{files}` | {next_action} |')
    status_md.append(f'| {cid} | {short} | {statement} | {status} | {evidence} | {confidence} | `{files}` | {next_action} |')
MD_PATH.write_text('\n'.join(rows_md) + '\n')
