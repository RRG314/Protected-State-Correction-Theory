...
| Constrained-observation recoverability branch | exact/approximate/asymptotic/impossible recovery under coarse records | OCP-043 nested restricted-linear collision-gap threshold law | same-record weaker-versus-stronger split; phase-loss and hidden-mode no-gos | broad cross-domain threshold language failed | strongest open theorem branch in repo | yes, heavily |
