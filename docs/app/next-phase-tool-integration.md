...
- generator script: [`scripts/compare/run_next_phase_examples.py`](../../scripts/compare/run_next_phase_examples.py)
- validation gate hook: [`scripts/validate/run_all.sh`](../../scripts/validate/run_all.sh)
- consistency tests: [`tests/examples/test_next_phase_examples_consistency.py`](../../tests/examples/test_next_phase_examples_consistency.py)
