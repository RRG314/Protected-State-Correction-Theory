...
## 1. Generator Characterization Beyond Projectors
...
This is the single strongest next theorem direction.

## 2. Sector-Based Theorem Program Beyond QEC
...
## 3. Boundary-Sensitive Continuous OCP
