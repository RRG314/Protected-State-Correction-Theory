...
| Status clutter/process-log tone | `SYSTEM_REPORT.md`, `FINAL_REPORT.md`, `docs/meta-governance/internal/repo_cleanup/*alignment*` | High | P1 | Reduced repeated promoted/demoted phrasing; retained status labels only where they change interpretation. |
...
| --- | --- | --- | --- |
| Companion boundary ambiguity | `README.md`, `docs/meta-governance/internal/repo_cleanup/companion_repo_map.md`, `docs/integration/repo_scope_statement.md` | Medium | Clarified home-of-record split and admissible bridge scope. |
