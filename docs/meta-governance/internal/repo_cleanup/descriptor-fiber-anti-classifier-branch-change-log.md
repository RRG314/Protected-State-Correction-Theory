...
- `docs/meta-governance/internal/repo_cleanup/paper_and_report_structure.md`

## Legacy Retention

- `docs/meta-governance/internal/meta_theory/` retained and relabeled as supporting/historical archive.
