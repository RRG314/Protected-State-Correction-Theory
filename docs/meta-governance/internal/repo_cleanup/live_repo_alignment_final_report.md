...
Align live/public presentation with current strongest local serious state while reducing front-door clutter and preserving important history.

## What Changed

### 1. Public identity and front door
...
1. Theorem/proof/no-go backbone files were preserved.
2. Workbench UX structure remained recognizable.
3. Historical pass documents were kept for provenance.
