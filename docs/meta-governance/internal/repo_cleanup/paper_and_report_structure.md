...
| Unifying-theory refinement | `docs/meta-governance/internal/unifying_theory/final_theory_refinement_master_report.md` | other `docs/meta-governance/internal/unifying_theory/*` analyses |
...
| Discovery/falsification/novelty layer | `docs/meta-governance/internal/docs-discovery/master_discovery_portfolio.md`, `docs/falsification/master_falsification_report.md`, `docs/literature/master_novelty_pressure_report.md` | `docs/research-program/*` dated passes |
