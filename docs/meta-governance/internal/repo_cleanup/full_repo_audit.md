...
- Major density hotspots:
  ...
  - `docs/meta-governance/internal/unifying_theory/` (new canonical theory layer)
...
- Both `docs/meta-governance/internal/soliton-branch/` and `docs/meta-governance/internal/soliton_branch/` exist with overlapping purposes.
- Decision: keep both paths for compatibility; treat `docs/meta-governance/internal/soliton-branch/` as canonical.
...
- `docs/meta-governance/internal/unifying_theory/final_theory_identity.md`
- `docs/meta-governance/internal/unifying_theory/theorem_hierarchy_final.md`
- `docs/meta-governance/internal/unifying_theory/final_universal_core_theorems.md`
- `docs/meta-governance/internal/unifying_theory/branch_limited_strengthening_final.md`
- `docs/meta-governance/internal/unifying_theory/final_theory_refinement_master_report.md`
...
- `docs/structural-docs/meta-governance/internal/discovery-notes/*`
...
- `docs/meta-governance/internal/soliton_branch/*` (legacy alias path)
  - canonical set: `docs/meta-governance/internal/soliton-branch/*`

### Merge Needed (Semantic, Not Deletion)
- Thematic overlap across:
  - `docs/research-program/*` status reports,
  - `docs/meta-governance/internal/unifying_theory/*` final theory package,
