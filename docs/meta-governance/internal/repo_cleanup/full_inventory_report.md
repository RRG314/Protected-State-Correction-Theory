...
- `falsification/`
- `docs/meta-governance/internal/discovery-notes/`
- `discovery-portfolio/`
- `validations/`
...
- `docs/meta-governance/internal/discovery-notes/summary.json`
- `docs/meta-governance/internal/discovery-notes/run_new_structure_exploration.py`
- `docs/meta-governance/internal/discovery-notes/README.md`
...
- `docs/meta-governance/internal/discovery-notes/tsit_source_map.md`
- `docs/meta-governance/internal/discovery-notes/tsit_claim_extraction.md`
- `docs/meta-governance/internal/discovery-notes/tsit_falsification_report.md`
- `docs/meta-governance/internal/discovery-notes/tsit_reduction_attack_report.md`
...
2. Decide whether to track `docs/meta-governance/internal/discovery-notes/` sandbox outputs in this repo or keep them local-only.
3. If `docs/meta-governance/internal/discovery-notes/` is tracked, add schema/reproducibility checks for its catalogs/script.
