...
- Canonical final layer:
  - `docs/finalization/*` + `docs/meta-governance/internal/unifying_theory/*`
...
- Keep `docs/meta-governance/internal/soliton_branch/` for compatibility.
- Treat `docs/meta-governance/internal/soliton-branch/` as canonical branch path.

## Implementation Actions (This Pass)

- Added full cleanup/audit doc set in `docs/meta-governance/internal/repo_cleanup/`.
...
- Added legacy alias pointer doc for `docs/meta-governance/internal/soliton_branch/`.
