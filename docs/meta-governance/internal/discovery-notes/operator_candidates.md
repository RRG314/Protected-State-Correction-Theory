...
Primary data: `data/generated/operator_docs/meta-governance/internal/discovery-notes/operator_witness_catalog.csv` (1000 rows), `operator_anomaly_catalog.csv` (26 rows).
