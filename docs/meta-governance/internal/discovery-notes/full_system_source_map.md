...
- Canonical anchors:
  ...
  - `docs/meta-governance/internal/theorem_attempt/open_problems_after_promotion.md`
  - `docs/meta-governance/internal/theorem_attempt/proof_or_disproof_notes.md`
  - `docs/meta-governance/internal/theorem_attempt/proof_pressure_notes.md`
  - `docs/meta-governance/internal/theorem_attempt/soliton_recoverability_formalism.md`
  - `docs/meta-governance/internal/theorem_attempt/theorem_candidates.md`
...
## Known Risk Hotspots
- `topological-adam/docs/meta-governance/internal/discovery-notes/extracted/*` contains untracked theory text exports (including RGE/holography/black-hole language) with low confidence until independently replicated.
- `ocp-research-program/docs/meta-governance/internal/discovery-notes/*` and `docs/research-program/*` contain many exploratory/non-promoted packages; each claim needs theorem-status gating before promotion.
