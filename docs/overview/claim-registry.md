...
| OCP-012 | Exact-to-asymptotic bridge | DERIVABLE BUT NOT YET WRITTEN CLEANLY | formalism + exact and asymptotic branches | Medium | `docs/formalism/exact-vs-asymptotic.md` | Promote after upgrading the bridge from framework language to a sharper theorem statement. |
