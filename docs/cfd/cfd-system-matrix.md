...
| Bounded-domain projection with domain-compatible Hodge projector and matching boundary data | divergence-free velocity class with boundary constraints | contamination that preserves the admissible decomposition class | domain-compatible Hodge projector | exact in principle, but not proved in this repo beyond the classification statement | CONDITIONAL FIT | yes, conditional |
...
- The bounded-domain branch is worth keeping only in conditional form: the exact operator must be the domain-compatible Hodge projector for the protected class, not a boundary-oblivious transplant.
