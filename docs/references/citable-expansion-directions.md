...
## 5. Maxwell Constraint Preservation
...
## 6. Numerical-Relativity Constraint Damping
...
- cite Chorin / Helmholtz-style projection work when discussing exact continuous correction,
- cite Dedner / Gundlach / Abalos when discussing asymptotic correction and constraint damping,
