...
- `docs/finalization/*`
- `docs/unifying_theory/*` (final subset)
...
- Use `docs/repo_cleanup/canonical_document_map.md` as the role authority.
- Use `docs/repo_cleanup/canonical_reading_paths.md` for onboarding.
