...
| SOL-03 | CGL random-superiority instability | Random self-organization superiority signal collapses under artifact checks. | CGL self-organization benchmark lane. | `data/generated/discovery/anomalies/anomaly_catalog_expanded.json` (`A-CGL-SELF-ORG`). | falsified anomaly | ARTIFACT RISK |
...
| SDS-02 | Holography/black-hole extracts are non-canonical | High-claim thermodynamic/holographic material appears in extracted discovery text and remains outside canonical theorem/test spine. | Untracked extracted text bundle. | `discovery/extracted/RGE_Physical_Laws_2026.txt`. | placement/risk finding | OPEN |
