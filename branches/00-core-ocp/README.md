...
The strongest current references are `docs/theorem-core/architecture-final.md`, `docs/theorem-core/theorem-spine-final.md`, and `docs/theorem-core/no-go-spine-final.md`, together with `papers/ocp_core_paper.md`.
