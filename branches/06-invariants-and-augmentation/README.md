...
Canonical references are `docs/methods-diagnostics/invariant-lane/invariant_formal_audit.md`, `invariant_theorem_spine_draft.md`, `invariant_no_go_spine_draft.md`, and `invariant_formalization_and_bh_placement_master_report.md`.
