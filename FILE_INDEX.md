...
- [styles.css](docs/workbench/styles.css)
- [compute.js](docs/workbench/lib/compute.js)
- [state.js](docs/workbench/lib/state.js)
...
- [claim_registry.csv](data/generated/validations/claim_registry.csv)
- [operator_examples.json](data/generated/validations/operator_examples.json)
- [workbench_examples.json](data/generated/validations/workbench_examples.json)

## Open Problems
- [resolved-vs-open.md](docs/open-questions/resolved-vs-open.md)
- [open-problem-catalog.md](docs/open-questions/open-problem-catalog.md)
- [high-priority-next-problems.md](docs/open-questions/high-priority-next-problems.md)
